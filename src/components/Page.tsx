...
export function HeadPage(props: { children?: React.ReactNode, row?: boolean, height_screen?: boolean, classname?: string, style?: {} }) {
...
export function BodyPage(props: { children?: React.ReactNode }) {
	return (
		<div
...
export function NavbarPage(props: { children?: React.ReactNode }) {
...
export function FooterPage(props: { children?: React.ReactNode }) {
	const [active, setActive] = useState(false)
	const [colorChange, setColorChange] = useState(false)
	...
	return (
		<footer className="text-center bg-gray-900 text-white lg:text-left">
			<div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
				<div className="mr-12 hidden lg:block">
					<span>Get connected with us on social networks:</span>
				</div>
				<div className="flex justify-center">
					<a href="https://www.facebook.com/Fanzoca" className="rounded-full border-2 border-white text-white w-9 h-9 leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out m-1">
						<svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook-f"
							className="w-3 h-full mx-auto" role="img" xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 320 512">
					...
					<a href="https://www.instagram.com/mrgaaf_oficial_2002/" className="rounded-full border-2 border-white text-white w-9 h-9 leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out m-1">
          ...
          ">
			...
			<div className="text-center p-4 font-semibold" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
				<span>© 2022 Trionte</span>
			</div>
		</footer>
	)
}
